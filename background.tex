...
and high end-to-end latency along with unstable, intermittent network
connectivity due to potentially large physical distance \cite{buyya2019}.
...
consequently raised, favoring both end-devices and cloud servers.
...
% TODO An example for this interpretation of the terminology is presented by
